...
class _HVACModeEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_HVACMode.ValueType], _builtins.type):
    ...
    """iOS KMP 1.0.26 / user-confirmed: DRY dehumidification mode"""
...
class _HVACStateEnumTypeWrapper(_enum_type_wrapper._EnumTypeWrapper[_HVACState.ValueType], _builtins.type):
    ...
    """iOS KMP 1.0.26: DRY actively dehumidifying"""
    HVAC_STATE_DRY_DEFERRED: _HVACState.ValueType  # 12
    """iOS KMP 1.0.26: DRY waiting for mode-switch delay"""
    HVAC_STATE_DRY_PREPARING: _HVACState.ValueType  # 13
    """iOS KMP 1.0.26: DRY compressor pre-conditioning"""
...
class HVACState(_HVACState, metaclass=_HVACStateEnumTypeWrapper):
    ...
    DRY states added in iOS KMP 1.0.26 alongside HVAC_MODE_DRY.
    """
...
class LocalCommsHealthStatus(_LocalCommsHealthStatus, metaclass=_LocalCommsHealthStatusEnumTypeWrapper):
    ...
    Added in iOS KMP 1.0.26 alongside the local-control over-the-air update.
    iOS KMP source: com.quilt.models.hds.LocalCommsHealthStatus
    """
...
class LocalCommsStatus(_message.Message):
    """Wire-confirmed in 2026-06-04 mitmproxy capture (iOS 1.0.26).
    Carried as field 8 on QuiltSmartModule and field 9 on Controller.
    KMP app layer extracts only the `health` subfield (subfield 2).
    Subfields 3, 4, 6 are wire-confirmed but semantics TBD without the server proto source.
    """
    ...
    """current health; KMP: localCommsHealth"""
...
class Controller(_message.Message):
    ...
    def local_comms_status(self) -> Global___LocalCommsStatus:
        """iOS KMP 1.0.26: local mesh status for this Dial"""
...
class QuiltSmartModule(_message.Message):
    ...
    @_builtins.property
    def local_comms_status(self) -> Global___LocalCommsStatus:
        """iOS KMP 1.0.26: local mesh status for this QSM"""
